...
export const EDIT_CATEGORY = "ADD_CATEGORY";
export const EDIT_CATEGORY_SUCCESSFUL = "ADD_CATEGORY_SUCCESSFUL";
export const EDIT_CATEGORY_REJECTED = "ADD_CATEGORY_REJECTED";
