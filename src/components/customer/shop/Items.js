        ...
        if (this.props.leastItemPrice !== prevProps.leastItemPrice || this.props.mostItemPrice !== prevProps.mostItemPrice || this.state.times === 0) {
            ...
            if (this.props.sortAndFilter.minPrice === 0 && this.props.sortAndFilter.maxPrice === 0) {
                ...
                this.setState(
                    {
                        chosenVal: chosenVal,
                        leastPrice: this.props.leastItemPrice,
                        mostPrice: this.props.mostItemPrice,
                        times: 1
                    });
                    ...
                    <div className="container">
                        <div className="row">
                                        ...
                                        <div className="catagories-menu">
                                            <form>
                                                {categories.map(category =>
                                                    <Categories activeCategory={this.props.sortAndFilter.category}
                                                                key={category.idCategory} data={category}
                            ...
                            <div className="whole-products-div col-12 col-md-8 col-lg-9">
                                        ...
                                        <div className="col-12">
                                            <div
                                                ...
                                                <div className="total-products col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                                    <p><span>{this.props.pageProps.totalElements}</span> Products found
                                                    </p>
                                                </div>
                                ...
                                <div className="pagination-items col-lg-8 col-md-8 col-sm-10"
