...
import FooterImage from '../../images_sublime/polar_bear_footer.jpg';
import Footerlogo from '../../images_essence/core-img/logo2.png'
                                    ...
                                    <form action="#" method="post">
                                        <input type="email" name="mail" className="mail" placeholder="Your email here"/>
                                            <button type="submit" className="submit"><i
                                                className="fa fa-long-arrow-right" aria-hidden="true"/></button>
                                    </form>
                                </div>
                            </div>
                        </div>
